...
const navigation: Array<NavigationItem | string> = [
  ...
  { icon: 'revenues', label: 'Revenues', to: '/revenues' },
  { icon: 'invoices', label: 'Invoices', to: '/invoices' },
...
const pageTitles: Record<string, [string, string]> = {
  ...
  '/expenses': ['Expenses', 'Record, import, and reconcile costs'],
  '/revenues': ['Revenues', 'Record, import, and reconcile income'],
  '/transactions': ['Transactions', 'Review and record your bank-side movements'],
  '/invoices': ['Invoices', 'Create, issue, and review itemized invoices'],
  '/payments': ['Payments', 'Record invoice payments and reconcile transactions'],
  '/plans': ['Plans', 'Set targets and compare them with actuals'],
