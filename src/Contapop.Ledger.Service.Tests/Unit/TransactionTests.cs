...
public sealed class TransactionTests
{
    ...
    {
        var transaction = Transaction.Create(Guid.NewGuid(), Guid.NewGuid(), 1_250, new DateOnly(2026, 9, 8), "expense", DateTimeOffset.UtcNow);
    ...
    public void Archived_transaction_cannot_be_updated()
    {
        ...
        var updated = transaction.TryUpdate(2, null, 2_500, null, null, DateTimeOffset.UtcNow);
