...
public sealed class OutboxDispatcher(
    IDbContextFactory<LedgerDbContext> databaseFactory,
    ...
    ILogger<OutboxDispatcher> logger)
{
    ...
    private static async Task<OutboxMessage?> ClaimNextAsync(LedgerDbContext database, CancellationToken cancellationToken)
    {
        var now = DateTimeOffset.UtcNow;
        var candidate = await database.OutboxMessages.AsNoTracking()
